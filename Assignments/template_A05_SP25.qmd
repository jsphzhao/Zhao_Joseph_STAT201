...
minute_str <- ifelse(minutes == 1, "1 minute", paste(minutes, "minutes"))
second_str <- ifelse(seconds == 1, "1 second", paste(seconds, "seconds"))

cat(var_seconds, "seconds is", minute_str, "and", second_str, ".\n")
```
...
cat(i, "squared is", i^2, ", and is the first number whose square exceeds", threshold, ".\n")
```
